...
// ============================================================================
// Safe Read-Only Screen & Page Context Peeker (For Tabs Outside AI Workspace)
// ============================================================================
...
export async function handlePeekScreenCommand(
    ...
    try {
        ...
        try {
            const results = await chrome.scripting.executeScript({
                ...
                func: (limit: number) => {
                    ...
                    if (clone) {
                        const noise = clone.querySelectorAll("script, style, noscript, svg, iframe, nav, footer, header");
        ...
        return {
            error: `Failed to peek screen: ${e instanceof Error ? e.message : String(e)}`,
